...
/**
 * Servlet implementation class DeptnoSearch
 */
@WebServlet("/DeptnoSearch")
public class DeptnoSearch extends HttpServlet {
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ArrayList<Emp> Dlist = dao.getEmpListByDeptno(deptno);
