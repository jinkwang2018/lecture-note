			...
			jQuery.ajax({
				...
				success:function(data){
					...
					$.each(data,function(index,obj){
						...
						tablestr+="<td><a class='btn btn-primary' data-toggle='modal' data-target='#myModal1' href='memberedit?empno="+ obj.empno+"'id = 'toggleNavColor'>" + "수정" + "</a></td>";
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<input type="button" id="empno_btn" class='btn btn-primary' value="검색">
			<input type="button" id="emp_btn" class='btn btn-primary' value="전체검색">
			<input type="button" id="toggleNavColor" class='btn btn-primary' data-toggle='modal' data-target='#myModal2' value="추가">
			<br><br> 
						...
						<div class="form-row">
							<div class="col-md-6">
								<label for="exampleConfirmPassword">hiredate</label> <input
									...
									placeholder="Enter hiredate" value="tablestr>obj.hiredate" readonly>
							</div>
							<div class="col-md-6">
